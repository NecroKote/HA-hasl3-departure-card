...
import type { DepartureCardConfig } from "./DepartureCard/DepartureCard.config"
import type { TranslationKey } from "./translations"
import { getLanguage, translateTo } from "./translations"

@customElement("hasl4-departure-card-editor")
export class HASLDepartureCardEditor
    extends LitElement
    implements LovelaceCardEditor
{
    ...
    private _dispatchConfigChangedEvent(
        newConfig: Partial<DepartureCardConfig>,
    ) {
