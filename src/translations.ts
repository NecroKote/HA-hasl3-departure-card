...
export const translations: { [lang: string]: Translation } = {
    ...
    "sv-SE": {
        ...
        editor_show_departed_offeset:
            "... men visa avgångna för antal minuter sedan",
    ...
    "fr-FR": {
        ...
        editor_show_departed_offeset:
            "... mais montrer les départs depuis le nombre de minutes",
...
export const t = (key: TranslationKey, lang?: string): string =>
    (lang ? translations[lang]?.[key] : undefined) ?? defaultTranslation[key]
export const getLanguage = (configLang?: string): string =>
    configLang ?? navigator.language ?? defaultLang
export const translateTo = (lang?: string) => (key: TranslationKey) =>
    t(key, lang)
